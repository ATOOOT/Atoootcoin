...
{
    const char* pszTimestamp = "IST Times 23/May/2022 Was created";
    const CScript genesisOutputScript = CScript() << ParseHex("0436dc5d6a3d6550ff223e260fc467c9f3bbaf57a1db817ab8fb7e737e3ce779c931d8ac61512a360a00d99285a5d410dc6889bdc74e07569980848988d1dd23d9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x8c04214b0271dcc7650be2fd9e45a3a5d66ddebbbd9fbb28c389153f714aac3f"); //3
        ...
        genesis = CreateGenesisBlock(1653264114, 2084819736, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x9b8734642d4c66c9aea4a0906639527e1d542a12f58c380b881a6c2ba5a064cc"));
        ...
        vSeeds.emplace_back("seed.atooot.com");
        ...
        checkpointData = {
            {
                {  0, uint256S("0x9b8734642d4c66c9aea4a0906639527e1d542a12f58c380b881a6c2ba5a064cc")},
                {  3, uint256S("0x8c04214b0271dcc7650be2fd9e45a3a5d66ddebbbd9fbb28c389153f714aac3f")},
        ...
        chainTxData = ChainTxData{
            ...
            1654106882, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1653264648, 2238546, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xe78e118805321a77a961ad7f9a1137c057ff88bd7c9bdbdf14d4842b9af90619"));
        assert(genesis.hashMerkleRoot == uint256S("0x9bdb4634ed511019088705be525ff40882af78529728b264dc7aaf628d7367d6"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.atooot.com");
        ...
        checkpointData = (CCheckpointData) {
            {
                {2056, uint256S("e78e118805321a77a961ad7f9a1137c057ff88bd7c9bdbdf14d4842b9af90619")},
            }
        };
...
public:
    CRegTestParams() {
        ...
        checkpointData = {
            {
                {0, uint256S("5dcf78ec70caf7aad978947273ed93c1a541f6b1d5fc1d979d689a5a7d09660e")},
            }
        };
