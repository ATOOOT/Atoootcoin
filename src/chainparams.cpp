...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.atoootcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.atoootcointools.com");
        vSeeds.emplace_back("dnsseed.atoootcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.atoootcointools.com");
        vSeeds.emplace_back("seed-b.atoootcoin.loshan.co.uk");
