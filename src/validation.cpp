...
#if defined(NDEBUG)
# error "Atoootcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Atoootcoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s ATOOOT additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("atoootcoin-scriptch");
