...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s atoootcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  atoootcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded atoootcoin transaction") + "\n" +
              "  atoootcoin-tx [options] -create [commands]   " + _("Create hex-encoded atoootcoin transaction") + "\n" +
              "\n";
