...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s ATOOOT-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ATOOOT-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ATOOOT transaction") + "\n" +
              "  ATOOOT-tx [options] -create [commands]   " + _("Create hex-encoded ATOOOT transaction") + "\n" +
              "\n";
