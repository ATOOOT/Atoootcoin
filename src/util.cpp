...
const char * const BITCOIN_CONF_FILENAME = "ATOOOT.conf";
const char * const BITCOIN_PID_FILENAME = "ATOOOT.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "ATOOOT";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/ATOOOT";
#else
    // Unix
    return pathRet / ".ATOOOT";
#endif
#endif
}
