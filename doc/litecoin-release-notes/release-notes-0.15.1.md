...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 ATOOT per kB (0.00001 ATOOOT). This is to prepare for dropping the minimum transaction fee to 0.1 ATOOT per kB (0.0001 ATOOOT) in the next release.
