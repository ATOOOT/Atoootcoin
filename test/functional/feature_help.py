...
"""Verify that starting atoootcoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start atoootcoin with -h for help text")
        ...
        self.log.info("Start atoootcoin with -version for version information")
